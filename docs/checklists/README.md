...
Este directorio contiene las cuatro listas de comprobación exigidas por la guía,
cumplimentadas ítem por ítem contra el estado real del repositorio.
...
## Cómo leer estas listas

Cada ítem lleva una de tres marcas:

- `[x]` **Cumplido.** El artefacto existe y la columna «Evidencia» dice dónde
  comprobarlo.
- `[~]` **Parcial.** Existe algo, pero no satisface el ítem por completo. La
  columna dice qué falta.
- `[ ]` **No cumplido.** La columna dice por qué, sin atenuantes.
