    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Registrar un nuevo usuario del sistema</p>
            </div>
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="password" name="password"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-400"
                        placeholder="Déjalo vacío para usar 123456">
                    <p class="text-xs text-gray-400 mt-1">Si se deja vacío, se asigna la contraseña por defecto <strong>123456</strong>.</p>
                </div>
                ...
                <div>
                    ...
                    <select name="rolId" required
                        ...
                        @foreach ($roles as $rolId => $rol)
                            <option value="{{ $rolId }}" @selected(old('rolId') == $rolId)>{{ $rol }}</option>
                        @endforeach
                    </select>
                </div>
