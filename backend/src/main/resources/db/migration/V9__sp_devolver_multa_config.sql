-- M3: sp_devolver_prestamo usa el monto de multa diaria de la tabla configuracion
-- (antes usaba 0.50 hardcodeado mientras configuracion define 'monto_multa_diario' = 5.00)
...
BEGIN
    ...
    IF v_fecha_vencimiento < NOW() THEN
        ...
        SELECT p_prestamo_id, p.usuario_id, v_dias_retraso * v_multa_diaria, false, NOW()
