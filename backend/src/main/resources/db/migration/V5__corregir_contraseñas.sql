...
-- El hash del V3 ($2a$10$N9qo8uLOickg...) no corresponde a ninguna contraseña,
-- por lo que el login fallaba aunque la documentación decía admin123/biblio123/estudiante123.
